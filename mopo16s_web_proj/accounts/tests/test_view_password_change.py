...
class PasswordChangeTests(TestCase):
    def setUp(self):
        ...
        User.objects.create_user(username=username, email='paolo@posterdati.cc', password=password)
...
class PasswordChangeTestCase(TestCase):
    ...
    '''
    def setUp(self, data={}):
        self.user = User.objects.create_user(username='paolo', email='paolo@posterdati.cc', password='old_password')
        self.url = reverse('password_change')
        self.client.login(username='paolo', password='old_password')
